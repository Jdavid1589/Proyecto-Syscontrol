  ...
  <div class="container-fluid text-center mt-3">
        <div class="row">
            <div class="col-md-12 mx-auto">
                <br>
                <h1 class="text-primary elegant-font mt-5"><b>REGISTRAR PRODUCTOS</b></h1>

            </div>
        </div>
    </div>
            <form action="ControladorEspLodos" autocomplete="off" method="POST" class="custom-form">         

                <div class="Container ">
                    <div class="row">
                        <div class="col-md-6 ">
                            <div class="form-group text-left">
                                <label for="productos_idProductos"> 
                                    <b style="color: #00008B; font-family: Century Gothic;"> Referencia</b></label>
                                <select style="color: #000; font-family: Century Gothic ; font-size: 18PX;" class="form-control" id="productos_idProductos" name="idProductos">
                            ...
                            <div class="form-group text-left">
                                ...
                                <select class="form-control" id="clientes_idclientes" name="idclientes">
                        ...
                        <div class="col-md-12 mt-3 text-right">
                            <div class="form-group ms-auto ">
                                ...
                                <a href="./index3.jsp"class="btn  btn-success"> 
                                    <span class="text-warning">Inicio</span></a>
                            </div> 
                        </div> 
