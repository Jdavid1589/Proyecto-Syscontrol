        ...
        <form class="formulario" id="formulario" action="ControladorPL" method="post">
            ...
            <div class="formulario__grupo" id="grupo__fecha">
                ...
                <div class="formulario__grupo-input">
                    <input type="date" class="formulario__input" id="fecha"  value="<%=controlLodo.getFecha()%>" 
                           name="fecha" placeholder="%Solidos">
            ...
            <div class="formulario__grupo" id="grupo__producto">
                ...
                <select   class="formulario__input"   id="producto"   value="<%=controlLodo.getIdProductos()%>"
                          name="producto">
            ...
            <div class="formulario__grupo" id="grupo__seguimiento">
                ...
                <select  class="formulario__input" class="form-control" id="idSeguimiento"
                         value="<%=controlLodo.getIdSeguimiento()%>"   name="txtSto">
            ...
            <div class="formulario__grupo" id="grupo__lote">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="lote"  value="<%=controlLodo.getLote()%>" id="lote" placeholder="% lote">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>               
            </div>
            ...
            <div class="formulario__grupo" id="grupo__Cantidadkg">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="Cantidadkg" id="Cantidadkg"  value="<%=controlLodo.getCantiKgLodo()%>" placeholder="% Cantidadkg">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>               
            </div>
            <!-- Grupo: Solidos -->
            <div class="formulario__grupo" id="grupo__solidos">
                ...
                <div class="formulario__grupo-input">
                    <input  onkeyup="calcularHumedad(this);" type="text" class="formulario__input" 
                            name="solidos"   value="<%=controlLodo.getSolidos()%>" id="solidos" placeholder="%Solidos">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
            ...
            <div class="formulario__grupo" id="grupo__humedad">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input"  value="<%=controlLodo.getHumedad()%>" name="humedad" id="humedad" readonly="" placeholder="% humedad">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>               
            </div>
            ...
            <div class="formulario__grupo" id="grupo__pH">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="pH"  value="<%=controlLodo.getpH()%>" id="pH" placeholder="% pH">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
            ...
            <div class="formulario__grupo" id="grupo__r325">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="r325" id="r325"  value="<%=controlLodo.getRetenido325()%>" placeholder="% r325">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
                <p class="formulario__input-error error" id="error_r325">Error!  Validar R325 para la actual referencia</p>
            </div>
            ...
            <div class="formulario__grupo" id="grupo__ku">
                ...
                <p class="formulario__input-error error" id="error_ku">El ku debe estar entre 60-70</p>
            </div>
            <!-- Grupo: cP -->
            <div class="formulario__grupo" id="grupo__cP">
                <label for="cP" class="formulario__label">cP</label>
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="cP"  value="<%=controlLodo.getViscosidadCp()%>" id="cP" placeholder="% cP">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div>
            ...
            <div class="formulario__grupo" id="grupo__Brigh">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="Brigh"  value="<%=controlLodo.getBrigh()%>" id="Brigh" placeholder="% Brigh">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div> 
            ...
            <div class="formulario__grupo" id="grupo__Wh">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="Wh"  value="<%=controlLodo.getWhitness()%>" id="Wh" placeholder="% Wh">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div> 
            ...
            <div class="formulario__grupo" id="grupo__kgSodio">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="kgSodio"  value="<%=controlLodo.getKgCarbonatoSosio()%>" id="kgSodio" placeholder="% kgSodio">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div> 
            ...
            <div class="formulario__grupo" id="grupo__comentarios">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input" name="comentarios"  value="<%=controlLodo.getComentarios()%>" id="comentarios" placeholder="% comentarios">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div> 
            ...
            <div class="formulario__grupo" id="grupo__observacion">
                ...
                <div class="formulario__grupo-input">
                    <input type="text" class="formulario__input"  value="<%=controlLodo.getObservacion()%>" name="observacion" id="observacion" placeholder="% observacion">
                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                </div> 
            ...
            <div class="formulario__grupo formulario__grupo-btn-enviar">
                ...
                <button type="submit" name="accion" value="registrarEdicion2"  class="formulario__btn">EDITAR</button>
                <button type="submit" name="accion" value="registrar3" title="Boton si se Desea Grabar un Nuevo Registro "  
                class="formulario__btn2">GRABAR</button>
