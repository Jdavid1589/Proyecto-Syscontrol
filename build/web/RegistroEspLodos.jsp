...
<html>
    ...
    <body>
        ...
        <div class="container  mt-5 "> 
              <h1 class=" elegant-font text-primary">REGISTRO ESPECIFICACIONES LODOS</h1>
           
            <form action="ControladorPL" autocomplete="off" method="POST" class="custom-form">         
                    ...
                    <div class="row">
                        <div class="col-md-6 ">
                            <div class="form-group text-left">
                                ...
                                <select style="color: #000; font-family: Century Gothic ; font-size: 18PX;" class="form-control" id="productos_idProductos" name="productos_idProductos">
