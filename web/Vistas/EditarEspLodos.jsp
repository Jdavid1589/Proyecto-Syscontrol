        ...
        <div class="container col-md-12 text-center mt-5" style="background: #004085  ">
            <div class="row">
                <div class="col-md-6  mx-auto">
                    ...
                    <form action="ControladorEspLodos" method="POST" class="custom-form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group text-left">
                                    ...
                                    <input type="text" class="form-control" id="metodo1" name="metodo1" value="<%=especific.getMetodo1()%>"
                                ...
                                <div class="form-group text-left">
                                    ...
                                    <input type="text" class="form-control" id="metodo2" name="metodo2"  value="<%=especific.getMetodo2()%>" >
                                </div> 
                                ...
                                <div class="form-group text-left">
                                    ...
                                    <input type="text" class="form-control" id="metodo3" name="metodo3" value="<%=especific.getMetodo3()%>"
                                           placeholder="Ingrese Metodo">
                                </div> 
                                ...
                                <div class="form-group text-left">
                                    ...
                                    <input type="text" class="form-control" id="metodo4" name="metodo4" value="<%=especific.getMetodo4()%>"
                                           placeholder="Ingrese Metodo">
                                </div> 
                                ...
                                <div class="form-group text-left">
                                    ...
                                    <input type="text" class="form-control" id="metodo5" name="metodo5" value="<%=especific.getMetodo5()%>"
                                           placeholder="Ingrese Metodo">
                                </div> 
                            ...
                            <div class="col-md-6"> 
                                ...
                                <div class="form-group text-left">
                                    ...
                                    <input type="text" class="form-control" id="metodo6" name="metodo6" value="<%=especific.getMetodo6()%>"
                                           placeholder="Ingrese Metodo">
                                </div>
                                ...
                                <div class="form-group text-left">
                                    ...
                                    <input type="text" class="form-control" id="metodo7" name="metodo7" value="<%=especific.getMetodo7()%>"
                                           placeholder="Ingrese Metodo">
                                </div> 
                                ...
                                <div class="form-group text-left">
                                    ...
                                    <input type="text" class="form-control" id="metodo8" name="metodo8" value="<%=especific.getMetodo8()%>"
                                           placeholder="Ingrese Metodo">
                                </div> 
                                <div class="form-group text-left">
                                    <label for="variableEsp9" class="text-left"><b style="color: #28a745;">Variable # 9</b></label>
                                    <input type="text" class="form-control" id="variableEsp9" name="variableEsp9" value="<%=especific.getVariableEsp9()%>"
                                           placeholder="Ingrese Variable">
                                </div> 
                                <div class="form-group text-left">
                                    <label for="rango9" class="text-left">Rango # 9</label>
                                    <input type="text" class="form-control" id="rango9" name="rango9" value="<%=especific.getRango9()%>"  
                                           placeholder="Ingrese Rango">
                                </div>
                                <div class="form-group text-left">
                                    <label for="metodo9" class="text-left">Metodo # 9</label>
                                    <input type="text" class="form-control" id="metodo9" name="metodo9" value="<%=especific.getMetodo9()%>"
                                           placeholder="Ingrese Metodo">
                                </div> 

                                <div class="form-group text-left">
                                    <label for="variableEsp10" class="text-left"><b style="color: #28a745;">Variable # 10</b></label>
                                    <input type="text" class="form-control" id="variableEsp10" name="variableEsp10" value="<%=especific.getVariableEsp10()%>"
                                           placeholder="Ingrese Variable">
                                </div> 
                                <div class="form-group text-left">
                                    <label for="rango10" class="text-left">Rango # 10</label>
                                    <input type="text" class="form-control" id="rango10" name="rango10" value="<%=especific.getRango10()%>"  
                                           placeholder="Ingrese Rango">
                                </div>  
                                <div class="form-group text-left">
                                    <label for="metodo10" class="text-left">Metodo # 10</label>
                                    <input type="text" class="form-control" id="metodo10" name="metodo10" value="<%=especific.getMetodo10()%>"
                                           placeholder="Ingrese Metodo">
                                </div> 
                                <div class="form-group text-left">
                                    <label for="variableEsp11" class="text-left"><b style="color: #28a745;">Variable # 11</b></label>
                                    <input type="text" class="form-control" id="variableEsp11" name="variableEsp11" value="<%=especific.getVariableEsp11()%>"
                                           placeholder="Ingrese Variable">
                                </div> 
                                <div class="form-group text-left">
                                    <label for="rango11" class="text-left">Rango # 11</label>
                                    <input type="text" class="form-control" id="rango11" name="rango11" value="<%=especific.getRango11()%>"  
                                           placeholder="Ingrese Rango">
                                </div> 

                                <div class="form-group text-left">
                                    <label for="metodo11" class="text-left">Metodo # 11</label>
                                    <input type="text" class="form-control" id="metodo11" name="metodo11" value="<%=especific.getMetodo11()%>"
                                           placeholder="Ingrese Metodo">
                                </div> 
                            </div>
                        </div>
